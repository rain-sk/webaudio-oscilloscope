...
export function MediaStreamOscilloscope(
  mediaStream: MediaStream,
  canvasElement: HTMLCanvasElement,
  audioDest?: IAudioDestinationNode<AudioContext>,
  analyzerFFT = 2048,
  canvasInitFunction?: CanvasHookFunction,
  drawingPrimerFunction?: CanvasHookFunction
) {
